...
namespace KUtil {
	...
	public static class Easing {
        ...
        {
            float tt = funcList[(int)type](0f, 1f, t);
            vec3.x = Mathf.Lerp(start.x, end.x, t);
            vec3.y = Mathf.Lerp(start.y, end.y, t);
            vec3.z = Mathf.Lerp(start.z, end.z, t);
            return vec3;
        }
        ...
        {
            float tt = funcList[(int)type](0f, 1f, t);
            vec4.x = Mathf.Lerp(start.x, end.x, t);
            vec4.y = Mathf.Lerp(start.y, end.y, t);
            vec4.z = Mathf.Lerp(start.z, end.z, t);
            vec4.w = Mathf.Lerp(start.w, end.w, t);
            return vec4;
        }
        ...
        {
            float tt = funcList[(int)type](0f, 1f, t);
            col.r = Mathf.Lerp(start.r, end.r, t);
            col.g = Mathf.Lerp(start.g, end.g, t);
            col.b = Mathf.Lerp(start.b, end.b, t);
            col.a = Mathf.Lerp(start.a, end.a, t);
            return col;
        }
